...
| **Existing accounts without business (legacy OAuth)** | Users who signed up with Google/Microsoft before business name was required have no business_id. | Redirect to "Complete your account" or use manual SQL to create business and set business_id (see [USER_SETUP_GUIDE.md](USER_SETUP_GUIDE.md)), or delete the account. |
...
- [USER_SETUP_GUIDE.md](USER_SETUP_GUIDE.md) — User and profile setup, including legacy accounts without business_id.
