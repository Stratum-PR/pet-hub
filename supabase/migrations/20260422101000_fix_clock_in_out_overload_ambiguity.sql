-- Fix ambiguous function resolution for clock_in_out RPC.
-- Keep a single canonical signature and remove legacy/accidental overloads.

DROP FUNCTION IF EXISTS public.clock_in_out(text, uuid, numeric, numeric, text);
DROP FUNCTION IF EXISTS public.clock_in_out(text, uuid, numeric, numeric, text, text);
DROP FUNCTION IF EXISTS public.clock_in_out(text, text, numeric, numeric, text);
DROP FUNCTION IF EXISTS public.clock_in_out(text, text, numeric, numeric, text, text);
