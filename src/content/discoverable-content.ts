...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    name: 'Growth',
    price: null,
    description: 'Solo and small salons: core scheduling, booking, and payments.',
    features: [
      'Up to 50 clients and 5 GB storage',
      'Email support',
    ],
    popular: false,
  },
  {
    ...
    name: 'Standard',
    price: null,
    description: 'Growing teams: inventory, client portal, branding, and priority support.',
    features: [
      'Up to 5 staff, 200 clients, 25 GB',
      'Inventory, client portal, and custom branding',
    ],
    popular: true,
  },
  {
    ...
    name: 'Pro',
    price: null,
    description: 'Boarding, larger teams, commission tracking, and advanced analytics.',
    features: [
      'Up to 15 staff, unlimited clients, 100 GB',
      'Multi-day boarding and commission tools',
    ],
    popular: false,
  },
  {
    ...
    name: 'Enterprise',
    price: null,
    description: 'Multi-location operations, API access, and dedicated support.',
    features: [
      'Multi-location and unlimited scale',
      'API access and 24/7 support',
    ],
    popular: false,
    contactUs: true,
  },
...
export const PAGE_CONTENT: Record<string, PageContent> = {
  ...
  '/cookie-notice': {
    sections: [
      {
        heading: 'Cookies',
        body: 'Cookie and similar-technology notice for grumi.pet: categories (necessary, preferences, analytics, marketing), Google Analytics when enabled, consent, browser controls, and contact. Spanish and English via the site language control.',
      },
    ],
  },
  '/login': {
